      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div data-aos="zoom-in">
            <img
              src="https://imgs.search.brave.com/msSfd5RbQ1_Ri8wDdAj0ecxNbFP7MwJQGKEKPAOrsEk/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/dmVjdG9yc3RvY2su/Y29tL2kvcHJldmll/dy0xeC85OC82MC8x/MTExLXNob3BwaW5n/LWRheS1zYWxlLWJh/bm5lci13aXRoLXdh/dmUtbGlxdWlkLXZl/Y3Rvci0yNzYxOTg2/MC5qcGc"
              alt=""
              className="max-w-[400px] rounded-xl h-[350px] w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover"
            />
          </div>
          ...
          gap-6 sm:pt-0">
            ...
            >
              ...
              reiciendis inventore iste ratione ex 
